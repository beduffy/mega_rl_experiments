...
class DETRVAE(nn.Module):
    ...
    def __init__(self, backbones, transformer, encoder, state_dim, num_queries, camera_names):
        ...
        if backbones is not None:
            ...
            self.input_proj_robot_state = nn.Linear(self.num_actions, hidden_dim)
        else:
        ...
        self.encoder_joint_proj = nn.Linear(self.num_actions, hidden_dim)  # project qpos to embedding
